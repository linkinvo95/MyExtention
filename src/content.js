...
(async () => {
  chrome.runtime.onMessage.addListener( data => {
    // если текущая вкладка получила фокус, применить операции отметки / снятия отметки (если есть),
    // затем, если не было операции с меткой, обновить статистику маркера
